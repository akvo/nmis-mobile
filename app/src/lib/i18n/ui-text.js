const uiText = {
  en: {
    ...
    manageNewBlank: 'New Blank Form',
    manageEditSavedForm: 'Edit Saved Form',
  ...
  fr: {
    ...
    manageNewBlank: 'Nouveau formulaire vierge',
    manageEditSavedForm: 'Modifier le formulaire enregistré',

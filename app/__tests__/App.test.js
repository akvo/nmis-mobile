...
describe('App', () => {
  it('should update AppStore on NetInfo change', async () => {
    ...
    // Verify that AppStore.update was called with the expected state
    expect(AppStore.update).toHaveBeenCalledWith(expect.any(Function));
